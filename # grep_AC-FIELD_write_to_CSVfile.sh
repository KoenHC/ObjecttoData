...
grep -i -w 'art histor*' $FILE > art_history1.csv
grep -i -w 'archaeology and art' $FILE > art_history2.csv
grep -i -w 'archeology and art' $FILE > art_history3.csv
grep -i -w 'architecture' $FILE > art_history4.csv

grep -i    'classic*' $FILE > classics1.csv
grep -i -w 'Latin' $FILE > classics2.csv
grep -i -w 'Ancient Greek' $FILE > classics3.csv

grep -i    'histor*' $FILE > histor1.csv

grep -i -w 'film studies' $FILE > film_studies1.csv
grep -i    'cinema' $FILE > film_studies2.csv

grep -i -w 'language' $FILE > language1.csv
grep -i -w 'linguistic*' $FILE > language2.csv
...
grep -i    'theat*' $FILE > performing_arts3.csv
grep -i -w 'photography' $FILE > performing_arts4.csv
grep -i    'musician*' $FILE > performing_arts5.csv
